...
import { ArrowLeft, Building2, FileText, BarChart3, MessageCircle, CalendarCheck } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="perfil" value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid grid-cols-4 w-full">
          ...
          <TabsTrigger value="documentos" className="flex gap-2 items-center">
        ...
        <TabsContent value="documentos" className="mt-6">
          <Card>
            <CardHeader>
              <CardTitle>Documentos</CardTitle>
              <CardDescription>
                Documentos do cliente {cliente.nome}
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-8">
                ...
                <Button
                  className="mt-4 bg-w1-teal hover:bg-w1-teal/90"
                  onClick={() => navigate('/documentos-consultor')}
                >
